...
@Service
public class ArabicEnglishOnnxService extends BaseOnnxService {

    private final ArabicEnglishSourceVocabService sourceVocabService;
    private final ArabicEnglishTargetVocabService targetVocabService;

    public ArabicEnglishOnnxService(
            ArabicEnglishSourceVocabService sourceVocabService,
            ArabicEnglishTargetVocabService targetVocabService,
            StatisticsService statisticsService
    ) throws Exception {

        super(
                "/models/arabic-english/encoder.onnx",
                "/models/arabic-english/decoder.onnx",
                statisticsService
        );
